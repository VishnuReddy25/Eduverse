...
const Home=()=>{
    return(<div className="font-sans antialiased bg-gray-100">
    ...
    <main>
      <section className="bg-blue-500 text-white py-20 text-center">
        ...
        <img src="\images\eduverse.jpeg" alt="EduVerse Logo" className="mx-auto mb-8 rounded-full" style={{ maxWidth: '200px' }} />
          ...
          <div className="flex flex-wrap justify-center">
            <div className="w-full md:w-1/3 px-4 mb-8">
              <div className="bg-white rounded-lg shadow-md p-6">
                <img src="images\course-1.jpeg" alt="Course 1" className="mx-auto mb-4" style={{ maxWidth: '200px' }} />
            ...
            <div className="w-full md:w-1/3 px-4 mb-8">
              <div className="bg-white rounded-lg shadow-md p-6">
                <img src="\images\course-2.png" alt="Course 2" className="mx-auto mb-4" style={{ maxWidth: '200px' }} />
                <h3 className="text-xl font-bold mb-2">Data Science Fundamentals</h3>
                <p className="text-gray-700 mb-4">Learn the basics of data science and analysis techniques with ease.</p>
                <a href="#" className="bg-yellow-500 hover:bg-yellow-400 py-2 px-4 rounded-lg text-lg font-bold inline-block transition duration-300">Enroll Now</a>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto">
          ...
          <div className="flex flex-wrap justify-center">
            <div className="w-full md:w-1/2 px-4 mb-8">
              <div className="bg-yellow-300 rounded-lg shadow-md p-6">
                <img src="images\jhon-doe.jpeg" alt="Student 1" className="rounded-full mx-auto mb-4" style={{ width: '100px', height: '100px', objectFit: 'cover' }} />
                <p className="text-lg mb-4">"EduVerse has transformed my learning experience. Highly recommended for students.!"</p>
                <p className="text-gray-700">- John Doe</p>
              </div>
            </div>
            <div className="w-full md:w-1/2 px-4 mb-8">
              <div className="bg-yellow-300 rounded-lg shadow-md p-6">
                <img src="\images\jane-smith.jpeg" alt="Testimonial 2" className="rounded-full mx-auto mb-4" style={{ width: '100px', height: '100px', objectFit: 'cover' }} />
      ...
      <section className="bg-white py-20 text-center">
        <div className="container mx-auto">
          ...
          <div className="flex flex-wrap justify-center">
            <div className="w-full md:w-1/2 px-4 mb-8">
              <div className="bg-white rounded-lg shadow-md p-6">
                <img src="images\webinar.jpeg" alt="webinar 1" className="mx-auto mb-4" style={{ maxWidth: '200px' }} />
                ...
                <p className="text-gray-700 mb-4">Join us for an insightful webinar on the fundamentals of data science.Embark on an enlightening journey through the essential principles of data science with our captivating webinar.</p>
            ...
            <div className="w-full md:w-1/2 px-4 mb-8">
              <div className="bg-white rounded-lg shadow-md p-6">
                <img src="images\webinar-2.jpeg" alt="Cryptography Webinar" className="mx-auto mb-4" style={{ maxWidth: '200px' }} />
